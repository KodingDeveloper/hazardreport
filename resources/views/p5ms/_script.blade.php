    ...
    $(document).ready(function() {
        ...
        $("form[name='commodity_create']").submit(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    _token: token,
                    pegawai_id: $("#pegawai_id_create").val(),
                    departemen_id: $("#departemen_id_create").val(),
        ...
        $(".swal-edit-button").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#pegawai_id_edit").val(data.data.pegawai_id)
                    $("#departemen_id_edit").val(data.data.departemen_id)
                    $("#item_code_edit").val(data.data.item_code)
                    $("#name_edit").val(data.data.name)
                    $("#nrp_edit").val(data.data.nrp)
        ...
        $("#swal-update-button").click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    _token: token,
                    pegawai_id: $("#pegawai_id_edit").val(),
                    departemen_id: $("#departemen_id_edit").val(),
