        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="commodity_edit">
                    ...
                    <div class="col-lg-6">
              <div class="form-group">
                <label for="pegawai_edit">Pegawai</label>
                <select class="custom-select" id="pegawai_id_edit">
                  ...
                  @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="nrp_edit">Merek</label>
                                <input type="text" class="form-control" id="nrp_edit">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="departemen_id_edit">Lokasi</label>
                                <select class="custom-select" id="departemen_id_edit">
                                    <option selected>Pilih</option>
